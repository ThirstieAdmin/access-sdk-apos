...
- Create admin: `npx dotenv -e .env -- node app @apostrophecms/user:add myUsername admin` (We usually create `thirstieadmin` user: `npx dotenv -e .env -- node app @apostrophecms/user:add thirstieadmin admin`)
